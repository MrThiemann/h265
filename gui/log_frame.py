...
class LogFrame(ttk.LabelFrame):
    ...
    def setup_ui(self):
        ...
        # Log-Textbereich
        self.log_text = scrolledtext.ScrolledText(self, height=4, width=80,  # Sehr kompakte Höhe
                                                wrap=tk.WORD, state=tk.DISABLED)
        self.log_text.pack(fill=tk.BOTH, expand=True, padx=3, pady=3)
        
        # Button-Frame
        button_frame = ttk.Frame(self)
        button_frame.pack(fill=tk.X, padx=3, pady=(0, 3))
        ...
        # Status-Label
        self.status_label = ttk.Label(button_frame, text="Bereit", font=("Arial", 8))
