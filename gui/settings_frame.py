...
class SettingsFrame(ttk.LabelFrame):
    ...
    def setup_ui(self):
        ...
        row1 = ttk.Frame(self)
        row1.pack(fill=tk.X, pady=1)  # Minimaler Abstand von 2 auf 1
        ...
        row2 = ttk.Frame(self)
        row2.pack(fill=tk.X, pady=1)  # Minimaler Abstand von 2 auf 1
        ...
        row3 = ttk.Frame(self)
        row3.pack(fill=tk.X, pady=1)  # Minimaler Abstand von 2 auf 1
        ...
        row4 = ttk.Frame(self)
        row4.pack(fill=tk.X, pady=1)  # Minimaler Abstand von 2 auf 1
        ...
        row5 = ttk.Frame(self)
        row5.pack(fill=tk.X, pady=1)  # Minimaler Abstand von 2 auf 1
